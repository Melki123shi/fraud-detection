...
FRAUD_FEATURE_COLUMNS = [
    'purchase_value', 'age', 'signup_hour', 'purchase_hour', 'signup_month', 'purchase_month',
    'signup_is_weekend', 'purchase_is_weekend', 'time_since_signup',
    ...
    'is_high_risk_country', 'is_unknown_country',
